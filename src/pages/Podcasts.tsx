  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <NetflixHero
        ...
        contentType="Podcast"
        onPlay={() => featuredPodcast && handlePlay(featuredPodcast)}
        onMoreInfo={() => featuredPodcast && handleContentClick(featuredPodcast)}
      />
      ...
      <div className="pb-20 -mt-32 relative z-10">
        ...
        {content.length === 0 && (
          <div className="text-center py-20">
            <h2 className="text-2xl font-bold text-white mb-4">No Podcasts Available</h2>
            <p className="text-gray-400">Be the first to upload a podcast!</p>
          </div>
        )}
      </div>
